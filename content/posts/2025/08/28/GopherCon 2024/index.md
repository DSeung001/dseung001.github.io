...
서버 전환 과정에서의 고민
- Go 선택: Python 기반 API에서 복잡한 API가 필요 해졌는데 성능 이슈가 발생하여, 러닝커브와 성능 측면까지 고려하여 Go를 채택.
...
### 배운점
프로젝트는 비즈니스에 맞춰 설계할 수 밖에 없고 코드를 보면 비즈니스가 어떻게 흘러 갔는 지를 알 수 있다는 걸 다시금 깨달았습니다.<br/>
