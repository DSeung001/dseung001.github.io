...
현재 단계는 Judge LLM이나 문장 품질이 아니라, case를 고치고 split과 mode를 바꿔 같은 평가를 다시 돌릴 수 있게 만든 단계입니다. 
이제 계속 다듬어 나가며 진행할 예정입니다.

우선적으로는 사용자 평가로 인해 점수를 매칭할 있는 시스템을 만드는 게 가장 좋다고 생각합니다.
