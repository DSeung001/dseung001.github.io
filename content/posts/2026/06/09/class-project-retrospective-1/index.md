...
# 개요
1차 MVP를 [`http://43.201.141.69/`](http://43.201.141.69/)에 배포했습니다. <br/>
...
실 서비스를 배포하는 게 목표지만 결국엔 진짜 목적은 동영상을 다루는 서비스를 경험하는 부분이라서 다음처럼 스프린트 달력으로 당일 할 수 있는 영역을 정해서 진행하며 처지지 않도록 했죠.
![sprint](./sprint.webp)
