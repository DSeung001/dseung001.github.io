...
- CRF가 bitrate보다 효율적으로 보입니다. bitrate에 용량을 더 줘도 점수가 크게 오르지 않는 모습이지만, 용량은 비례해 올라가는 것을 확인할 수 있습니다.
...
위 테스트에서 CRF와 고정 비트레이트를 비교했고, 그 결과 비트레이트의 효율이 낮다고 정의 내렸습니다.
...
| preset | crf | avg_output_mib | avg_measured_mbps | avg_vmaf_mean | avg_vmaf_p5 | avg_vmaf_min |
| --- | --- | --- | --- | --- | --- | --- |
| fast | 20 | 42.91 | 1.2 | 96.4961 | 96.0678 | 86.0927 |
| fast | 22 | 34.93 | 0.977 | 96.0943 | 95.4819 | 86.2577 |
| fast | 24 | 28.65 | 0.801 | 95.66 | 94.7476 | 86.9226 |
| fast | 26 | 23.81 | 0.666 | 95.0709 | 93.7191 | 87.6512 |
| medium | 20 | 45.58 | 1.274 | 96.5871 | 96.2419 | 85.9814 |
| medium | 22 | 36.85 | 1.03 | 96.264 | 95.7546 | 86.143 |
| medium | 24 | 30.18 | 0.844 | 95.8536 | 95.0984 | 86.6804 |
| medium | 26 | 25.01 | 0.699 | 95.3291 | 94.2866 | 87.4335 |

crf 값에 따라 vmaf 점수도 마찬가지로 내려갔지만 평균값이 전부 93점 이상을 기록하는 걸 봐 품질이 괜찮게 나오는걸 알 수 있죠.
수치만 보면 fast 보다 미세하게 medium이 나은 점도 확인할 수 있죠. 용량을 아끼기 위해 crf는 22~26으로 가정하고 
품질 안정성도 고려해서 medium이 좋을 것 같습니다.

실제 영상의 캡쳐본을 보면 가장 품질이 안좋은 fast crf 20 또한 글자가 보기 어려울정도로 뭉게지지 않는 걸 체크했습니다.
![sample](./sample.webp)

다른 영상들도 눈으로는 차이를 체감하긴 쉽지 않았습니다. vmaf 1~2점의 차이는 크게 차이가 발생하지 않는걸로 느껴졌습니다.
최종적으로는 medium 24로 택하였습니다.
