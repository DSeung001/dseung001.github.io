...
- [4. 하이브리드 검색 엔진 구축 (Qdrant + Elastic Search)](#4-하이브리드-검색-엔진-구축-qdrant--elastic-search)
- [5. 대트래픽 대비 API 설계 및 최적화 (DRF & Caching)](#5-대트래픽-대비-api-설계-및-최적화-drf--caching)
...
# 3. 대용량 비동기 전처리 파이프라인
# 4. 하이브리드 검색 엔진 구축 (Qdrant + Elastic Search)
# 5. 대트래픽 대비 API 설계 및 최적화 (DRF & Caching)
